...
export default class GalleriesScreen extends Component<{}> {
    ...
    fetchData = async () => {
        return fetch('https://uppfeed.co.uk/api/2/image-galleries')
            ...
            <View style={styles.container}>
                ...
                <FlatList
                    ...
                    <View style={styles.menucontainer}>
                        <TouchableWithoutFeedback onPress={() => navigate('GalleryItems', {gallery: item})}>
                            <View>
                                <Image style={[styles.menuimage, item.gallery_main_image === null && styles.gone]}
                                  source={{ uri: 'https://uppfeed.co.uk/uploads/' + item.gallery_main_image }}
                                />
                                <View style={styles.menutitlewrap}>
                                    <Text style={styles.menutitle}>{item.gallery_title}</Text>
                                    <Text style={{ flex:1, textAlign:'right', padding:15, fontFamily: 'fontawesome', color:'white', lineHeight:20, }}>
                                        &#xf061;
                                    </Text>
                                </View>
                            </View>
